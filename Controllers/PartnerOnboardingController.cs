...
namespace API_Adda.Controllers
{
    public class PartnerOnboardingController : Controller
    {
        ...
        public PartnerOnboardingController()
        {
        ...
        public IActionResult ListofPartner(string Status = null)
        {
        ...
        //[HttpPost]
        //public IActionResult ListofPartner(string data)
        //{
        //    return View();
        //}
        ...
        public IActionResult AddEditPartner(PartnerOnboarding PartnerOnboarding/*, string PartnerRiskClassification, 
        ...
        //public IActionResult AddEditPartner1(PartnerOnboarding partnerApproval)
        //    {
        //    SubmitRepository submitrepository_obj = new SubmitRepository();
        //    partnerApproval = submitrepository_obj.HOPP_FunctionalHead();
            ...
            string txt_apiRisk, string txt_apiRiskScore)
        {
            try
            {
                ...
                objPartnerOnboarding.SpName = "Usp_APIA_PartnerOnBoardingNew";
        ...
        public IActionResult AddEditPartnerOnBoarding()
        {
            PartnerOnboarding partnerOnboarding = new PartnerOnboarding();
            PartnerRepository submitrepository_Obj = new PartnerRepository();
            ...
            partnerOnboarding.TentativeGoLiveDate = DateTime.Now;
        ...
        public IActionResult SaveAddPartneronBoarding(string jsonPartnerOnboarding/*, IFormFile AttachedJourneyDocuments, IFormFile APIRiskAssessment, IFormFile OtherDocument*/, string next = null)
        {
            try
            {
                ...
                if (next == "Request For Approval")
                {
                    ...
                    objPartnerOnboarding.AttachedClientProfileSheet = Request.Form.Files["AttachedClientProfileSheet"] != null ? fileData.CaseID + "_AttachedClientProfileSheet" : null;
                    ...
                    {
                        StoreFileLocally(Request.Form.Files["AttachedClientProfileSheet"], fileData.CaseID, "AttachedClientProfileSheet");
        ...
        public IActionResult EditPartneronBoarding(string id, string status)
        {
            var PartnerTypeList = (from product in submitrepository_Obj.GetPartnerTypeList()
                                   select new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem()
                                   { Text = product.PartnerType, Value = product.PartnerType }).ToList();
        ...
        public IActionResult SaveEditPartner(PartnerOnboarding data)
        {
            try
            {
                ...
                return RedirectToAction("ListofPartner", partnerEdit);
            }
            catch (Exception ex)
            {
                throw;
        ...
        //public ActionResult FeedbackPartial(POFeedbackHistory model)
        //{
        //    return PartialView("_FeedbackPartial", model);
        //}
        [HttpPost]
        ...
        //[HttpPost]
        //public void SaveFeedbackReply(string reqData)
        //{
        ...
        //   // var result = submitrepository_Obj.SaveFeedbackReply(obj);
        ...
        public IActionResult EditPartneronBoardingNew(string id, string status)
        {
            var PartnerTypeList = (from product in submitrepository_Obj.GetPartnerTypeList()
                                   select new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem()
                                   { Text = product.PartnerType, Value = product.PartnerType }).ToList();
        ...
        public IActionResult SaveEditPartnerNew(string jsonPartnerOnboarding)
        {
            try
            {
                ...
                data.AttachedClientProfileSheet = Request.Form.Files["AttachedClientProfileSheet"] != null ? data.CaseID + "_AttachedClientProfileSheet" : null;
                var partnerEdit = submitrepository_Obj.EditPartnerDraft(data);
                var AttachedClientProfileSheet = Request.Form.Files["AttachedClientProfileSheet"];
                ...
                if (AttachedClientProfileSheet != null && AttachedClientProfileSheet.Length > 0)
                {
                    DeleteFile(data.CaseID + "_AttachedClientProfileSheet");
                    StoreFileLocally(Request.Form.Files["AttachedClientProfileSheet"], data.CaseID, "AttachedClientProfileSheet");
                }
